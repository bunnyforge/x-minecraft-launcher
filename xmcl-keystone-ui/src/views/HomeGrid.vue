<template>
  ...
  >
    ...
    >
      ...
      />
      <GameServerList
        v-else-if="isType(item.i, CardType.GameServerList)"
      />
    </GridItem>
  </GridLayout>
</template>
...
const layouts = useLocalStorageCache('cardsLayout', () => ({
  md: [
    ...
    { x: 0, y: 9, w: 6, h: 8, minW: 3, minH: 6, i: rawType(CardType.GameServerList) },
  ],
  lg: [
    { x: 0, y: 0, w: 3, h: 9, minW: 2, minH: 4, i: rawType(CardType.Mod) },
    { x: 9, y: 0, w: 3, h: 9, minW: 2, minH: 4, i: rawType(CardType.ResourcePack) },
  ...
  sm: [
    ...
    { x: 0, y: 10, w: 4, h: 8, minW: 2, minH: 6, i: rawType(CardType.GameServerList) },
  ],
  xs: [
    { x: 0, y: 0, w: 2, h: 6, minW: 2, minH: 4, i: rawType(CardType.Mod) },
    ...
    { x: 0, y: 12, w: 4, h: 8, minW: 2, minH: 6, i: rawType(CardType.GameServerList) },
  ],
