    ...
    <div class="relative mx-6 flex-grow flex gap-6 items-end">
      ...
      >
        ...
        <v-btn
          ...
          large
          class="ml-2"
          @click="showLaunchConfig"
        >
          <v-icon>settings</v-icon>
        </v-btn>
      </div>
      <HomeLaunchConfigDialog />
    </div>
  </div>
</template>
...
import HomeLaunchConfigDialog from './HomeLaunchConfigDialog.vue'
...
const { show: showLaunchConfig } = useDialog('HomeLaunchConfigDialog')
