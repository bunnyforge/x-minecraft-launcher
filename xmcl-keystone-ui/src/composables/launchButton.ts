...
import { TaskState, LaunchOptions } from '@xmcl/runtime-api'
...
export interface LaunchMenuItem {
  ...
  rightIcon?: string
  color?: string
  onClick?: (overrides?: Partial<LaunchOptions>) => void
}
...
export function useLaunchButton() {
   ...
   */
  async function onClick(overrides?: Partial<LaunchOptions>) {
    ...
    launchButtonFacade.value.onClick?.(overrides)
  }
